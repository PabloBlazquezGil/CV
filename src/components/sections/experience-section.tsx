      ...
      <div className="max-w-3xl mx-auto space-y-12">
        {experience.map((expCategory) => (
          <div key={expCategory.category}>
            <h3 className="text-2xl font-headline font-semibold text-primary mb-6">{expCategory.category}</h3>
            <div className="relative space-y-8">
              ...
              {expCategory.items.map((item, index) => (
                <div key={index} className="relative pl-12">
                   <div className="absolute left-0 top-1.5 w-7 h-7 bg-secondary rounded-full flex items-center justify-center">
