...
export const titles = {
  ...
  investigacion: "Bioquímico experto en Sostenibilidad"
};

export const summaries = {
  comunicacion: [
    "Comunicador y divulgador científico con formación en Bioquímica, especializado en conectar ciencia y sociedad a través de contenidos creativos, formatos audiovisuales y experiencias interactivas.",
  ...
  investigacion: [
    "Investigador bioquímico enfocado en la aplicación de la ciencia para abordar desafíos medioambientales, la sostenibilidad y la economía circular.",
    "He participado activamente en programas para la conservación del medio ambiente, incluyendo iniciativas como el programa ATLIC para la defensa y promoción de la economía azul, combinando mi conocimiento científico con un firme compromiso por un futuro sostenible.",
